# Cloud Engineering & DevOps Internship Journal  
...
During my internship and transition into full-time responsibilities, I work across the following areas:
...
- IAM and access control debugging  
- Compute configuration and optimization  
- Storage access management  
- Networking and security group configuration  
- Cloud resource provisioning and tagging  
...
- Handling state management and debugging provisioning issues  
- Improving automation and repeatability of deployments  

---

### 3. Containerization & Application Deployment  
...
- Working with GitHub Actions for automated deployments  
- Managing Jenkins pipelines for build and deployment workflows  
- Automating infrastructure and application delivery processes  
...
- Visualizing system metrics with Grafana  
- Tracking infrastructure health and performance metrics  
- Supporting reliability improvements through metric analysis  
